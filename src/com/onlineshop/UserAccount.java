...
public class UserAccount extends JFrame {
    ...
    public UserAccount() {
        ...
        rechargeButton.setMaximumSize(btnSize);
        ...
        JButton[] buttons = {rechargeButton, shopButton, logoutButton};
        ...
        User.getInstance().addCreditListener((Double newCredit) -> {
            creditLabel.setText("Credit: " + newCredit.intValue() + " Toman");
        });
        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            if (rs.next()) {
                ...
                creditLabel.setText("Credit: " + credit + " Toman");
                userId = rs.getInt("id");
                nameLabel.setText(fullName);
                idLabel.setText("Username : " + username);
        ...
        shopButton.addActionListener(e -> new ShopUIForUsers());
        
        rechargeButton.addActionListener(e -> {
            String amountStr = JOptionPane.showInputDialog(this, "Enter amount to recharge (Toman):");
            if (amountStr != null && !amountStr.isEmpty()) {
                try {
                    ...
                    if (amount > 0) {
                        ...
                        double updatedCredit = fetchCreditFromDatabase(username);
                        session.setCredit(updatedCredit);
                        updateCredit(updatedCredit);

                        if (Cart.openCartInstance != null) {
                        	Cart.openCartInstance.updateBalance();
                        }

                        JOptionPane.showMessageDialog(this,
                        	    amount + " Toman has been added to your balance.\n" +
                        	    "Your total credit is now: " + updatedCredit + " Toman.",
                        	    "Recharge Successful",
                    ...
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(this, "Error recharging balance.");
                }
            }
        });
    ...
    public void updateCredit(double newCredit) {
